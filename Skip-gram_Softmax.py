...
from collections import defaultdict
model_name = "/word2vec python/wiki_text8_word2vec"     # Dimension 300, 47K words
model_w2v = word2vec.Word2Vec.load(model_name) 
...
for word, voca in model_w2v.wv.vocab.items():  
    index+=1             
    word2index[ word ] = index
    token_dict[word] =   index
    word2vec_weight.append( model_w2v[word] )
